...
export const homePagePedidosMock: IPedidoModel[] = [
  {
    ...
    fotos: [
      {
        id: '1',
        url: 'https://static.portaldacidade.com/unsafe/https://s3.amazonaws.com/umuarama.portaldacidade.com/img/news/2021-03/com-geladeira-vazia-mae-faz-apelo-para-conseguir-comida-e-leite-para-criancas-605c85330b7a0.jpeg',
      },
    ],
    endereco: [
  ...
  },
  {
    ...
    descricao:
      'Ofereço aulas de reforço em matemática e física para alunos do ensino médio de maneira gratuita a título de experiência.',
    contato: '(81)98765-4321',
    categoria: 'Educação',
    validado: true,
    userId: '_idMock6',
    fotos: [{ id: '6', url: 'https://www.rbsdirect.com.br/imagesrc/27448837.jpg?w=700' }],
    endereco: [
      {
        id: '5',
        estado: 'Pernambuco',
  ...
  },
  {
    ...
    fotos: [
      {
        id: '7',
        url: 'https://megacestabasicarj.com.br/wp-content/uploads/2016/11/produto-cesta-basica-media-510x600.jpg',
      },
    ],
    endereco: [
      {
  ...
  },
  {
    ...
    descricao:
      'Advogados oferecem apoio jurídico gratuito para pessoas que não têm condições de contratar um advogado.',
    contato: '(81)98765-4321',
    categoria: 'Serviços',
    validado: true,
    userId: '_idMock10',
    fotos: [
      {
        id: '8',
        url: 'https://fmp.edu.br/wp-content/uploads/2021/02/qual-e-o-papel-do-advogado-corporativo-a-fmp-te-mostra.jpg',
      },
    ],
    endereco: [
      {
